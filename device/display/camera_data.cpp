                                                                            ...
                                                                            const bool is_detail)
{
    ...
    static constexpr auto DetailTargetWidth = 720;
    static constexpr auto TargetQuality = 55;
    static constexpr auto DetailTargetQuality = 90;
    ...
    scalingfactor.num = 1;
    if (is_detail) {
        scalingfactor.denom = 1 << (int)log2((double)src_width / DetailTargetWidth);
    } else {
    ...
    if (tjCompress2(tj_instance,
                    ...
                    is_detail ? DetailTargetQuality : TargetQuality,  // Quality
                    TJFLAG_FASTDCT | TJFLAG_FASTUPSAMPLE) != 0) {
