...
const std::vector<DeviceParameterType> AEHaitai::EssentialParameterTypes = {DeviceParameterType::Kernel,
                                                                            DeviceParameterType::BaudRate};

const std::vector<DeviceParameterType> AEHaitai::OptionalParameterTypes = {};

auto _ = DeviceFactory::register_type({.type = DeviceVendorType::OdometryAEHaitai,
                                       .type_name = "odometry/aehaitai",
                                       .create = &AEHaitai::create,
                                       .do_convert = &AEHaitai::do_convert,
                                       .essential_parameter_types = AEHaitai::EssentialParameterTypes,
                                       .optional_parameter_types = AEHaitai::OptionalParameterTypes,
#ifdef WITH_DRIVER
...
HeraErrno AEHaitai::adjust_parameter(DeviceParameterType type, const std::string& value)
{
    switch (type) {
