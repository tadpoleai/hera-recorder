HERA_PLUGIN_DATA_DEFINE_START(VelodynePacket, 0x0501)
...
using VelodynePacketFullSynced = VelodynePacket;

HERA_PLUGIN_DATA_DEFINE_START(VelodynePacketUnSynced, 0x0502)
HERA_PLUGIN_DATA_DEFINE_END

HERA_PLUGIN_DATA_DEFINE_START(VelodynePacketLocalSynced, 0x0503)
HERA_PLUGIN_DATA_DEFINE_END
