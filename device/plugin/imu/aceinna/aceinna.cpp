...
const std::vector<std::string> Aceinna::EssentialParameterTypes = {"Kernel", "BaudRate", "SerialMsgType"};

const std::vector<std::string> Aceinna::OptionalParameterTypes = {};

HERA_DEVICE_DRIVER_EXPORT_PLUGIN(ImuAceinna, "imu/aceinna", Aceinna)
