...
#include "flir_timestamp_calculator.inc"
...
const std::vector<std::string> Flir::EssentialParameterTypes = {"IpAddress"};

const std::vector<std::string> Flir::OptionalParameterTypes = {"Exposure",
                                                               "WhiteBalanceRed",
                                                               "WhiteBalanceBlue",
                                                               "FrameRate"};

HERA_DEVICE_DRIVER_EXPORT_PLUGIN(CameraFlir, "camera/flir", Flir);
...
HeraErrno Flir::adjust_parameter(const std::string& type, const std::string& value)
{
    if (type == "IpAddress") {
