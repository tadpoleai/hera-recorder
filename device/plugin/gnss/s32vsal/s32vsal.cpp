...
const std::vector<std::string> S32VSal::EssentialParameterTypes = {"SubVendorType"};

const std::vector<std::string> S32VSal::OptionalParameterTypes = {};

HERA_DEVICE_DRIVER_EXPORT_PLUGIN(GnssS32VSal, "gnss/s32vsal", S32VSal)
...
HeraErrno S32VSal::connect()
{
    ...
    try {
        sub_vendor_type = parameters_["SubVendorType"];
    } catch (...) {
