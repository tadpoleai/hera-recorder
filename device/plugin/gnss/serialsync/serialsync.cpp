...
const std::vector<std::string> Serialsync::EssentialParameterTypes = {"Kernel",
                                                                      "KernelAuxiliary",
                                                                      "BaudRate",
                                                                      "BaudRateAuxiliary",
                                                                      "SerialMsgType"};

const std::vector<std::string> Serialsync::OptionalParameterTypes = {};

HERA_DEVICE_DRIVER_EXPORT_PLUGIN(GnssSerialsync, "gnss/serialsync", Serialsync)
