...
const std::vector<std::string> Serial::EssentialParameterTypes = {"Kernel", "BaudRate"};

const std::vector<std::string> Serial::OptionalParameterTypes = {};

HERA_DEVICE_DRIVER_EXPORT_PLUGIN(GnssSerial, "gnss/serial", Serial)
