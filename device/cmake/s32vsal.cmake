...
# Find S32V CrossCompile
set(PLUGIN_DRIVER_FOUND 0)
if(EXISTS ${S32VSAL_LIB_DIR}
   AND EXISTS ${S32VSAL_IMPORT_LIB_DIR}
   AND EXISTS ${S32VSAL_ROSAARCH_LIB_DIR})

  if(ARCHITECTURE STREQUAL "arm64")
    message_plugin("Architecture is arm64")
    if(DEFINED ENV{CROSS_COMPILE})
      message_plugin("Target is arm64 and cross compile is $ENV{CROSS_COMPILE}")
      set(PLUGIN_DRIVER_FOUND 1)
    endif()
  endif()

  if(NOT PLUGIN_DRIVER_FOUND)
    message_plugin(
      "S32VSal Libraries found but target is not arm64 or not cross compile")
  endif()

else()
  message_plugin("S32VSal Libraries not found")
endif()

if(PLUGIN_DRIVER_FOUND)
  # Set libraries
  message_plugin("Setting up Libraries for S32VSal")
  ...
  set(PLUGIN_DRIVER_DEP_LIBS ${S32VSAL_LIBS})
endif()
