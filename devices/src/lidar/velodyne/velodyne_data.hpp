...
/// @brief Class VelodyneStorageData
/// @version 0.1
/// @date 2019-11-07
///
...
///
/// @brief Storage data for Velodyne Lidar, Derived from Storage Data
///
/// @anchor manual
/// @see <a href="https://shorturl.at/bnsxY" target="_blank"
/// rel="noopener noreferrer">VLP-16-User-Manual</a>
///
class VelodyneStorageData final : public StorageData {
public:
    VelodyneStorageData() = delete;
...
public:
    ...
    ///
    union {
        VelodyneRawData data;                  ///< union entry: data with structure
        uint8_t buf[sizeof(VelodyneRawData)];  ///< union entry: raw buffer of bytes
    };
};
