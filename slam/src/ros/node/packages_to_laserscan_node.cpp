...
int main(int argc, char** argv)
{
    ...
    if (laser_type.compare(laser_type) == 0) {
         packages_sub = nh_.subscribe(package_topic,
                10,
                &AccumulatorVelodyne::original_points_callback,
                accumulator.get());
        ...
        pointcloud_sub.registerCallback(boost::bind(&Pointcloud2LaserScanVelodyne::pointcloud_callback, translator.get(), _1));
